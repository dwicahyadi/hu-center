...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h3>{{ \Illuminate\Support\Facades\Auth::user()->cluster }} /
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-striped bg-white">
            ...
            @forelse($data as $row)
                <tr>
                    <td>
                        <a href="{{ route('stock.hu1',['hu2_no'=>$row->hu2_no]) }}"><i class="icon-th-list mx-2 text-info" title="Open Detail"></i> Open</a>
                    </td>
                    @foreach($thead as $head)
