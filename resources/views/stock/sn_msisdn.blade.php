    ...
    <div class="card">
        <div class="card-body">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('stock.hu1',['hu2_no'=>$hu2_no ]) }}">{{ $hu2_no }}</a></li>
                <li class="breadcrumb-item active">{{ $hu1_no }}</li>
            </ol>
        </div>
    </div>
...
{{--                <th width="5rem">Option</th>--}}
            ...
            @forelse($data as $row)
                <tr>
{{--                    <td>--}}
{{--                        <a href=""><i class="icon-th-list mx-2 text-info" title="Open Detail"></i> Open</a>--}}
{{--                    </td>--}}
                    @foreach($thead as $head)
