<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="nav navbar-nav mr-auto">
        ...
        <a class="nav-item nav-link" href="{{ route('stock.search') }}"><i class="icon-upload text-danger"></i> Stock Out</a>
        <a class="nav-item nav-link" href="{{ route('stock.search') }}"><i class="icon-search "></i> Search</a>
    </div>
